...
struct task_params {
    ...
    bool qlazy            = false; // only consider non-thinking tokens for common prefix calculations
...
struct server_prompt_cache {
    server_prompt_cache(int32_t limit_size_mib, size_t limit_tokens, bool qlazy) {
